    ...
    public class SimulatorCamera : BaseINPC, ICamera {
        ...
        public async Task<IExposureData> DownloadExposure(CancellationToken token) {
            switch (Settings.Type) {
                ...
                //    var image = await survey.GetImage(string.Empty, coordinates, Astrometry.DegreeToArcmin(1), Settings.SkySurveySettings.WidthAndHeight, Settings.SkySurveySettings.WidthAndHeight, token, default(IProgress<int>));
