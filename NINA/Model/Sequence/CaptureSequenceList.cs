...
namespace NINA.Model {
    ...
    public class CaptureSequenceList : BaseINPC {
        ...
        public static CaptureSequenceList Load(string fileName, ICollection<MyFilterWheel.FilterInfo> filters) {
            using (var s = new FileStream(fileName, FileMode.Open)) {
                return Load(s, fileName, filters);
            }
        }

        public static CaptureSequenceList Load(Stream stream, string fileName, ICollection<MyFilterWheel.FilterInfo> filters) {
            CaptureSequenceList l = null;
            try {
                XmlSerializer xmlSerializer = new XmlSerializer(typeof(CaptureSequenceList));

                l = (CaptureSequenceList)xmlSerializer.Deserialize(stream);
                AdjustSequenceToMatchCurrentProfile(filters, l);
            } catch (Exception ex) {
                Logger.Error(ex);
        ...
        private static void AdjustSequenceToMatchCurrentProfile(ICollection<MyFilterWheel.FilterInfo> filters,  CaptureSequenceList l) {
        ...
        public static List<CaptureSequenceList> LoadSequenceSet(Stream stream, ICollection<MyFilterWheel.FilterInfo> filters) {
