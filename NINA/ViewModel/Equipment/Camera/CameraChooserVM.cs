...
namespace NINA.ViewModel.Equipment.Camera {
    ...
    internal class CameraChooserVM : EquipmentChooserVM {
        ...
        public CameraChooserVM(IProfileService profileService) : base(profileService) {
        ...
        public override void GetEquipment() {
            ...
            Devices.Add(new Model.MyCamera.FileCamera(profileService));
            Devices.Add(new Model.MyCamera.Simulator.SimulatorCamera(profileService));
